...
export default function AuthPage() {
  ...
  const handleAuth = async (e: FormEvent) => {
    ...
    try {
      ...
      console.log(data)
      const response = await axios.post('http://localhost:4200/user/get-user', data,{
        headers: {
      ...
      <div className="flex w-full max-w-4xl bg-white rounded-lg shadow-2xl overflow-hidden min-h-[500px]">
        ...
        <div className="w-full md:w-2/3 p-12 flex flex-col justify-center bg-white">
          <div className="mb-10 text-center md:text-left">
            <h1 className="text-2xl font-bold text-gray-800 mb-2">Авторизация</h1>
            <p className="text-gray-500 text-sm">Введите ваши данные для доступа к системе</p>
          </div>
